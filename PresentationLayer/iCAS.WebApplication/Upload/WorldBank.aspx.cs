...
{
    public partial class WorldBank : BasePage
    {
        #region Declaration
        ...
        {
            PageVariables.EstablishmentList = EstablishmentManagement.GetInstance.GetEstablishmentListByTypeCode("W");
        ...
        private string UploadFileGetNewFileName()
        {
            ...
            if (fileUploadEstb.HasFile)
            {
                ...
                else
                {
                    ...
                    theNewFileName = string.Format("WB_{0}_Y{1}_M{2}_D{3}-H{4}_M{5}_S{6}{7}",
