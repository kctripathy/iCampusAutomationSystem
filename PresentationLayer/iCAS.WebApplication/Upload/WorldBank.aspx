<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="WorldBank.aspx.cs" Inherits="Micro.WebApplication.UPLOAD.WorldBank" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMicroERP" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel_Establishment" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <h1 class="PageTitle">
                <asp:Literal runat="server" ID="lit_PageTitle" Text="MANAGE World Bank Assisted OHEPEE Project FILES:" />
            </h1>
                    ...
                    <ul id="UploadStyleUL">
                        ...
                        <li class="Formvalue" style="display:none;">
                            ...
                            <asp:RadioButtonList ID="rbl_EstablishmentTypeCode" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="W" Selected="True">World Bank Assisted OHEPEE Project</asp:ListItem>
                            </asp:RadioButtonList>
                        ...
                        <li class="Formlabel">
                            <asp:Label ID="lbl_Description" runat="server" Text="Brief Description (max 200 alphabets):" />
                            <span class="RequiredField">*</span>
                        </li>
                        <li class="Formvalue">
                            <asp:TextBox ID="txt_Description" runat="server" Height="100px" Width="100%" TextMode="MultiLine" MaxLength="200" /><br />
                            <%--<ajax:TextBoxWatermarkExtender runat="server" ID="TextBoxWatermarkExtender_txt_Description" TargetControlID="txt_Description" WatermarkText="Description " WatermarkCssClass="watermark" />--%>
                        ...
                        <li class="GridView">
                            <asp:GridView ID="gridview_Establishment" runat="server" AllowPaging="True" AllowSorting="True" PageSize="30" AutoGenerateColumns="False" OnRowCommand="gridview_Establishment_RowCommand" OnRowDeleting="gridview_Establishment_RowDeleting" OnRowEditing="gridview_Establishment_RowEditing">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EstbViewStartDate" HeaderText="Date" DataFormatString="{0:dd/MMM/yyyy}"  HeaderStyle-Width="15%" />
