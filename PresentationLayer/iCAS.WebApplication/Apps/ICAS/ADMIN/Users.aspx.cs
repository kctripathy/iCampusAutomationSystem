	...
	public partial class Users : BasePage
	{
		...
		private void BindEmployee()
		{
            if (ddl_UserType.SelectedIndex != 0 && ddl_UserType.SelectedIndex != 2 && ddl_UserType.SelectedIndex != 3)
            {
                ...
                ddl_UserReferenceName.DataSource = StaffMasterManagement.GetInstance.GetEmployeeList();
                ddl_UserReferenceName.DataTextField = StaffMasterManagement.GetInstance.DisplayMember;
                ddl_UserReferenceName.DataValueField = StaffMasterManagement.GetInstance.ValueMember;
            ...
            {
                ddl_UserReferenceName.Enabled = true;
                ddl_UserReferenceName.DataSource = StudentManagement.GetInstance.GetStudentList();
                ddl_UserReferenceName.DataTextField = StudentManagement.DisplayMember;
                ddl_UserReferenceName.DataValueField = StudentManagement.DisplayValue;
                ddl_UserReferenceName.DataBind();
            }
		...
		private void BindUserType()
		{
			...
			ddl_UserType.Items.Insert(2, new ListItem("Student"));
