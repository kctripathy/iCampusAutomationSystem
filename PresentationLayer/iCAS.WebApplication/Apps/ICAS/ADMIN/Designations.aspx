<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="Designations.aspx.cs" Inherits="Micro.WebApplication.MicroERP.HRMS.Designations" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMicroERP" runat="server">
 <h1 class="PageTitle">
		<asp:Literal runat="server" ID="lit_PageTitle" Text="Manage Designation Details" />
                ...
                <ajax:TabContainer runat="server" ID="tab_Designations" ActiveTabIndex="1" autopostback="true" onactivetabchanged="tab_Designations_ActiveTabChanged">
				...
				<asp:View ID="view_InputControls" runat="server">
                 ...
                 <asp:View ID="view_GridView" runat="server">
					<ul class="GridView">
						...
						<li>
							<micro:UC_Search ID="ctrl_Search" runat="server" SearchLabel="Search Designation(s), where:" />
						</li>
                    ...
                    <ajax:TabPanel ID="tab_DesignationSelect" runat="server" HeaderText="DesignationSelect">
                    <ContentTemplate>
                   <asp:MultiView runat="server" ID="Multiview_Desig">
				<asp:View ID="view_GridViewDesig" runat="server">
                <ul class="GridView">
                
                <asp:GridView runat="server" ID="gview_DesignationSelect" AutoGenerateColumns="False"  AllowPaging="False" PageSize="25" Width="98%" CssClass="GridView"  CellPadding="2"  OnRowDataBound="gview_DesignationSelect_RowDataBound" >
								<PagerStyle HorizontalAlign="Center" CssClass="MicroPagerStyle" />
								<HeaderStyle CssClass="HeaderStyle" />
								<Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DesignationOfficeID"  Visible="true">
							            <ItemTemplate>
