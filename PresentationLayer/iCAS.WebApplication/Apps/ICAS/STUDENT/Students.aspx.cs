...
namespace Micro.WebApplication.APPS.ICAS.STUDENT
{
    public partial class Students : BasePage
    {
        ...
        void BindStudentProfile()
        {
            ...
            {
                if (ex.Message == "Sequence contains no elements" || ex.Message =="Object reference not set to an instance of an object.")
                {
                    Student_Multi.SetActiveView(InputControls);
                }
            }
        ...
        private int UpdateStudent()
        {
            ...
            ProcReturnvalue = StudentManagement.GetInstance.UpdateStudent(PageVariables.ThisStudent);
