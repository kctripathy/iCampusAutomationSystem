<%@ Page Title="Admission " Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="StudentAdmissionFees.aspx.cs" Inherits="Micro.WebApplication.APPS.ICAS.STUDENT.StudentAdmissionFees" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMicroERP" runat="server">
    ...
    <h1 class="PageTitle">
        <asp:Literal runat="server" ID="lit_PageTitle" Text="Student Admission Fees Entry:" />
    </h1>
        ...
        <ContentTemplate>
            <ul class="StudentFullWidth">
                <asp:RadioButtonList runat="server"
                    ...
                    <asp:ListItem Selected="True" Value="1"> Step1- Select the Student >></asp:ListItem>
                    <asp:ListItem Value="2" Enabled="False"> Step2- Admission Fees Entry >></asp:ListItem>
                    <asp:ListItem Value="3" Enabled="False"> Step3- Save and Add New >></asp:ListItem>
                </asp:RadioButtonList>
            </ul>
                    ...
                    <div>
                        <ul id="Button">
                            <li class="FormButton_Top">
                                ...
                                <asp:Button ID="btn_ViewList" runat="server" Text="<- View/Select Student&nbsp;&nbsp;" CausesValidation="false" OnClick="btn_View_Click" />&nbsp;&nbsp;
                                <asp:Button ID="btn_MoveNext" runat="server" Text=" Click Here For Admission Fees Entry -> " CausesValidation="true"      OnClick="btn_MoveNext_Click" />
