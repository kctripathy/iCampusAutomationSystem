<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="LeaveApplications.aspx.cs" Inherits="LTPL.ICAS.WebApplication.APPS.ICAS.STAFFS.LeaveApplications" %>
                            ...
                            <ul>
                                ...
                                <li class="FormLabelGridview">
                                    <asp:GridView ID="gridview_LeaveApplyBalance" runat="server" AllowPaging="True"  AutoGenerateColumns="False" BorderStyle="None" CellPadding="4" GridLines="None" Height="45px" OnPageIndexChanging="gridview_LeaveApplyBalance_PageIndexChanging" PageSize="7" Width="100%">
                                        <Columns>
                                            <asp:BoundField DataField="LeaveTypeDescription" HeaderText="Leave Type">
                                            <HeaderStyle HorizontalAlign="Left" /> </asp:BoundField>
                                            <asp:BoundField DataField="TotalNumberOfLeavesElligibleToAvail" HeaderText="Balance of Leaves"> 
                                            <HeaderStyle HorizontalAlign="Left" /></asp:BoundField>
                                            <asp:BoundField DataField="NumberOfConsecutiveDaysAllowed" 
                                                HeaderText="Consecutive Allowed" >
