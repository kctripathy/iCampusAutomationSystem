...
{
    public partial class StaffPayComponents : System.Web.UI.Page
    {
        ...
        protected void EmployeePayrollComponents_RowCommand(object sender, GridViewCommandEventArgs e)
        {

        }

        protected void EmployeePayrollComponents_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {

        }

        protected void EmployeePayrollComponents_RowEditing(object sender, GridViewEditEventArgs e)
        {

        }

        protected void EmployeePayrollComponents_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        {
            if (e.CommandName == MicroConstants.COMMAND_GO)
            {
                Label lblId = (Label)e.Item.FindControl("lblId");
                lblemployeeBind.Text = lblId.Text;
                BindEmployeePayComponents(int.Parse(lblId.Text));
                if (GridBindEmpPayComponents.Rows.Count > 1)
                {
        ...
        {                        
            ...
            if (GridBindEmpPayComponents.Rows.Count == 0)
            {
                DataTable dt = new DataTable();
                dt.Columns.Add("RecordNo");
                dt.Columns.Add("PayComponentName");
                dt.Columns.Add("PayComponentDesc");
                dt.Columns.Add("PayComponentType");
                dt.Columns.Add("PayComponentAmount");              
                dt.Rows.Add(dt.NewRow());
                GridBindEmpPayComponents.DataSource = dt;
                GridBindEmpPayComponents.DataBind();
                GridBindEmpPayComponents.Rows[0].Visible = false;
            }
            ////GridBindEmpPayComponents.Rows
        }
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                dialog_Message.Show();
                lbl_message.Text = ReadXML.GetFailureMessage("EMPLOYEE_NOT_SELECTED_THEN");
            }
        }
        ...
        protected void GridBindEmpPayComponents_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                //Label lblbindPtype = (Label)e.Row.FindControl("lblbindPtype");
                //if (lblbindPtype.Text == "Result")
                //{
