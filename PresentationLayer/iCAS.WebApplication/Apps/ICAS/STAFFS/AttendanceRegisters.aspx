<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="AttendanceRegisters.aspx.cs" Inherits="LTPL.ICAS.WebApplication.APPS.ICAS.STAFFS.AttendanceRegisters" %>
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_AttendanceRegisterEmployee">
        <ContentTemplate>
            <div>
             ...
             <IAControl:DialogBox ID="DialogBox1" runat="server" Title="Message:" BackgroundCssClass="modalBackground"
        Style="display: none" CssClass="modalPopup" EnableViewState="true">
        <ItemTemplate>
            <ul>
                <li>
