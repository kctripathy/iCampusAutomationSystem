<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="AccountHeads.aspx.cs" Inherits="LTPL.ICAS.WebApplication.APPS.ICAS.FINANCE.AccountHeads" %>
			...
			<asp:MultiView runat="server" ID="multiView_AccountHeads">
				<asp:View runat="server" ID="view_InputControls">
					...
					<ul id="AccountHead">
                        ...
                        <li class="FormLabel">
							<asp:Label ID="lbl_IsPrimary" runat="server" Text="Is Primary" />
							<asp:Label runat="server" ID="lbl_IsPrimary_validator" Text="*" CssClass="ValidationColor" />
						</li>
						<li class="FormValue">
						<asp:CheckBox runat="server" ID="chk_isPrimary" AutoPostBack="false" Checked="false" 
                                Text="Check If Delete Restricted" Visible="true" />

						</li>
						<li class="FormLabel">
							<asp:Label ID="lbl_ParentAccountHeadName" runat="server" 
                                Text="Under (Account Heads) :" />
						</li>
						<li class="FormValue">
							<asp:DropDownList runat="server" ID="ddl_ParentAccountHeadName" />
							<asp:CheckBox runat="server" ID="chk_TreatAsSubHead" AutoPostBack="True" 
                                Checked="false" OnCheckedChanged="chk_TreatAsSubHead_CheckedChanged" 
                                Text=" Treat as Sub-Head" />
							<asp:RequiredFieldValidator runat="server" 
                                ID="requiredFieldValidator_ParentAccountHeadName" 
                                ControlToValidate="ddl_ParentAccountHeadName" Display="Dynamic" Enabled="false" 
                                SetFocusOnError="true" ValidationGroup="X" />
						</li>
					</ul>
				</asp:View>
