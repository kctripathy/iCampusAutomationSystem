...
namespace Micro.WebApplication.MicroERP.FINANCE
{
    ...
    public partial class AccountTransactions : BasePage
    {
        ...
        protected void btn_Delete_CheckedItem_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow EachRow in gview_AccountTransaction.Rows)
            {
                ...
                if (EachCheckBox.Checked)
                {
                    ...
                    int ProcReturnValue = AccountTransactionManagement.GetInstance.DeleteAccountTransaction(TheAccountTransaction);
                }
                BindGridView();
            }
        }
        ...
        private void Bind_Accounts()
        {
            ...
            ddl_Accounts.Items.Insert(0, MicroConstants.DROPDOWNLIST_DEFAULT_ITEMTEXT);
        }
        ...
        private bool ValidateOpeningBalance()
        {
            ...
            if (PageVariables.OpeningBalance < 0 && !ddl_Accounts.SelectedItem.Text.Equals("Opening Balance"))
            {
                ResetOpeningBalanceInfo();
        ...
        private int InsertRecord()
        {
            ...
            TheAccountTransaction.AccountID = int.Parse(ddl_Accounts.SelectedValue);
        ...
        public static int DeleteRecord()
        {
            ...
            ProcReturnValue = AccountTransactionManagement.GetInstance.DeleteAccountTransaction(PageVariables.ThisAccountTransaction);
            return ProcReturnValue;
        }
        ...
        private void ResetOpeningBalanceInfo()
        {
            ...
            ddl_Accounts.SelectedValue = ddl_Accounts.Items.FindByText("Opening Balance").Value;
        }
