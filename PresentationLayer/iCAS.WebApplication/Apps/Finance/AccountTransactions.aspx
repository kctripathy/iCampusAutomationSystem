<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="AccountTransactions.aspx.cs" Inherits="Micro.WebApplication.MicroERP.FINANCE.AccountTransactions" %>
			...
			<asp:MultiView runat="server" ID="multiView_AccountTransaction">
				<asp:View runat="server" ID="view_InputControls">
					...
					<ul id="AccountTransaction">
						...
						<li class="FormLabel">
							<asp:Label runat="server" ID="lbl_Accounts" Text="Accounts " />
							<asp:Label runat="server" ID="lbl_AccountsValidator" Text="*" CssClass="ValidationColor" />
						</li>
						<li class="FormValue">
							<asp:DropDownList runat="server" ID="ddl_Accounts" Width="140" />
							<asp:RequiredFieldValidator runat="server" ID="requiredFieldValidator_Accounts" ControlToValidate="ddl_Accounts" Display="Dynamic" SetFocusOnError="true" />
						</li>
						<li class="FormLabel">
				...
				<asp:View ID="view_GridView" runat="server">
					<ul class="GridView">
						...
						<li class="FormSearch">
							<micro:UC_Search ID="ctrl_Search" runat="server" SearchLabel="Search Transaction(s), where:" />
						</li>
						...
						<li>
							<asp:GridView runat="server" ID="gview_AccountTransaction" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" CssClass="GridView" PageSize="25" PagerSettings-Position="Bottom" Width="98%" OnPageIndexChanging="gview_AccountTransaction_PageIndexChanging" OnRowCommand="gview_AccountTransaction_RowCommand" OnRowDataBound="gview_AccountTransaction_RowDataBound" OnRowDeleting="gview_AccountTransaction_RowDeleting">
								...
								<Columns>
									...
									<asp:BoundField DataField="TransactionDate" HeaderText="Transaction Date" ItemStyle-CssClass="TransactionDate" />
									...
									<asp:BoundField DataField="ThirdPartyDescription" HeaderText="ThirdParty" ItemStyle-CssClass="ThirdPartyDescription" />
									<asp:BoundField DataField="TransactionAmount" HeaderText="Transaction Amount" ItemStyle-CssClass="TransactionAmount" />
