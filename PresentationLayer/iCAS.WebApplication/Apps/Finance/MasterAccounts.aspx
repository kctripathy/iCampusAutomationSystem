<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/MicroERP-MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterAccounts.aspx.cs" Inherits="Micro.WebApplication.MicroERP.FINANCE.MasterAccounts" %>
	...
	<asp:MultiView runat="server" ID="multiview_AccountsMaster" ActiveViewIndex="0">
		<asp:View ID="view_InputControls" runat="server">
			...
			<ul id="AccountsMaster">
				...
				<li class="FormValue">
					<asp:DropDownList runat="server" ID="ddl_AccountGroup" Width="300px" Height="20px" />
				</li>
				<!-- Accounts  Name -->
				<li class="DividerLine" />
				<li class="FormLabel">
		...
		<asp:View runat="server" ID="view_Grid">
			<ul class="GridView">
				...
				<li>
					<asp:GridView runat="server" ID="grid_AccountsMaster" AutoGenerateColumns="false" Width="100%">
						<Columns>
							<asp:BoundField DataField="AccountLedgerID" HeaderText="ID" />
							<asp:BoundField DataField="AccountGroupDescription" HeaderText="Group " />
							<asp:BoundField DataField="AccountLedgerDescription" HeaderText="Name " />
