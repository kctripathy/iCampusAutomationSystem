<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/ICAS.Master" AutoEventWireup="true" CodeBehind="MinutesOfMeeting.aspx.cs" Inherits="Micro.WebApplication.MinutesOfMeeting" ValidateRequest="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel_Establishment" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <div class="innercontent">
                <h1 class="PageTitle">
                    <asp:Literal runat="server" ID="lit_PageTitle" Text="Governing Body: Minutes of Meeting-" />

                </h1>
                <div class="OptionsStyle">
                    <asp:CheckBoxList ID="chkBoxList_EstbType" runat="server" Visible="false"
                        RepeatDirection="Horizontal"
                        RepeatColumns="9"
                        OnSelectedIndexChanged="chkBoxList_EstbType_SelectedIndexChanged"
                        AutoPostBack="true">
                        <asp:ListItem Value="1" Selected="True" Enabled="false"> Minutes of Meetings&nbsp;</asp:ListItem>
                    </asp:CheckBoxList>
                </div>
                    ...
                    <asp:View ID="view_gridView" runat="server">
                        ...
                        <asp:GridView ID="gridview_Establishment"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="EstbViewStartDate" HeaderText="Meeting Date:" DataFormatString="{0:dd/MMM/yyyy}" HeaderStyle-Width="10%" />
                                <asp:BoundField DataField="EstbTitle" HeaderText="Title/Subject:" HeaderStyle-Width="40%" />
                                <asp:HyperLinkField
