...
namespace TCon.iCAS.WebApplication.Database
{
    ...
    public partial class ADMN_MST_Calendar
    {
        public int TheDateID { get; set; }
        public System.DateTime CalendarDate { get; set; }
        public string CalendarDateDesc { get; set; }
        public string IsMicroHoliday { get; set; }
        public string IsLocalHoliday { get; set; }
        public string IsGovtHoliday { get; set; }
