...
namespace TCon.iCAS.WebApplication.Database
{
    ...
    public partial class ADMN_MST_UserRolePermissionExceptions
    {
        public int UserPermissionExceptionID { get; set; }
        public Nullable<int> UserID { get; set; }
        public Nullable<int> FormOrMenuID { get; set; }
        public string FormOrMenu { get; set; }
