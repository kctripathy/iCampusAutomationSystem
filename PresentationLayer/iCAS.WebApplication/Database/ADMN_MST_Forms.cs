...
namespace TCon.iCAS.WebApplication.Database
{
    ...
    public partial class ADMN_MST_Forms
    {
        public int FormID { get; set; }
        public string FormName { get; set; }
        public string ActualFormName { get; set; }
        public string ActualFormNameWeb { get; set; }
        public string ActualFormClassName { get; set; }
        public string ActualFormClassNameWeb { get; set; }
