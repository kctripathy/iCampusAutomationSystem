...
namespace Micro.ErrorLogger
{
    ...
    public class ErrorLog
    {
        ...
        public static Boolean CreateLog(Exception objException, bool bLogType = false)
        {
            try
            {
        ...
        private static bool CheckLoggingEnabled()
        {
            try
            {
                return Boolean.Parse(ConfigurationManager.AppSettings["EnableLogErrors"].ToString());
            }
            catch
            {
                return true;
        ...
        {
            string strCheckinBaseDirecotry = AppDomain.CurrentDomain.BaseDirectory + "ErrorLogging.Config";

            if (File.Exists(strCheckinBaseDirecotry))
                return strCheckinBaseDirecotry;
            else
            {
                string strCheckinApplicationDirecotry = GetApplicationPath() + "ErrorLogging.Config";
        ...
        private static string GetLogFilePath()
        {
            try
            {
                ...
                string retFilePath = baseDir + "//" + LogFilePath;
