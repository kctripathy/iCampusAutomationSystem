    ...
    public partial class UserDataAccess : AbstractData_SQLClient
    {
        ...
        public DataRow GetUserByLoginName(string loginName)
        {
            using (SqlCommand SelectCommand = new SqlCommand())
            {
                ...
                SelectCommand.CommandText = "pADM_Users_SelectByLoginNameOrPhoneNo";
                return ExecuteGetDataRow(SelectCommand);
            }
        }

        public DataRow GetUserByLoginNameOrPhoneNo(string loginNameOrPhone)
        {
            using (SqlCommand SelectCommand = new SqlCommand())
            {
                SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public int InsertUser(User theUser)
        {
            ...
            {
                AddedByUserId = Micro.Commons.Connection.LoggedOnUser.UserID;
            }
            using (SqlCommand InsertCommand = new SqlCommand())
            {
                ...
                InsertCommand.Parameters.Add(GetParameter("@AddedBy", SqlDbType.Int, AddedByUserId));
        ...
        {
            int ReturnValue = 0;
            int AddedByUserId = -8; int OfficeID = 44;
            if (Micro.Commons.Connection.LoggedOnUser != null)
            {
                AddedByUserId = Micro.Commons.Connection.LoggedOnUser.UserID;
            }
            using (SqlCommand InsertCommand = new SqlCommand())
            {
                ...
                InsertCommand.Parameters.Add(GetParameter("@ReturnValue", SqlDbType.Int, ReturnValue)).Direction = ParameterDirection.Output;
                InsertCommand.Parameters.Add(GetParameter("@UserName", SqlDbType.VarChar, theUser.UserName));
                InsertCommand.Parameters.Add(GetParameter("@UserPhone", SqlDbType.VarChar, theUser.PhoneNumber));
                InsertCommand.Parameters.Add(GetParameter("@UserEmail", SqlDbType.VarChar, theUser.EmailAddress));
                InsertCommand.Parameters.Add(GetParameter("@RoleID", SqlDbType.Int, theUser.RoleID));
                //InsertCommand.Parameters.Add(GetParameter("@Password", SqlDbType.VarChar, theUser.Password));
                //InsertCommand.Parameters.Add(GetParameter("@UserType", SqlDbType.VarChar, theUser.UserType));
                //InsertCommand.Parameters.Add(GetParameter("@UserReferenceID", SqlDbType.Int, theUser.UserReferenceID));
                ...
                InsertCommand.Parameters.Add(GetParameter("@AddedBy", SqlDbType.Int, AddedByUserId));
                InsertCommand.CommandText = "[pADM_Users_Insert4Registration]";
