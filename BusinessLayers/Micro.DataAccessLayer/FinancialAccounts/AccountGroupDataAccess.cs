...
namespace Micro.DataAccessLayer.FinancialAccounts
{
    public partial class AccountGroupDataAccess : AbstractData_SQLClient
    {
        ...
        public DataTable GetAccountGroupList(string searchText = "", bool showPrimary = false)
        {
            ...
            SelectCommand.CommandText = "pFIN_AccountGroups_SelectAll";

            return ExecuteGetDataTable(SelectCommand);
        }


		public DataTable GetAccountGroupList(int groupID)
		{
			SqlCommand SelectCommand = new SqlCommand();

			SelectCommand.CommandType = CommandType.StoredProcedure;
			SelectCommand.Parameters.Add(GetParameter("@GroupID", SqlDbType.Int, groupID));
			SelectCommand.CommandText = "[pFIN_AccountGroups_SelectAllByGroupID]";
