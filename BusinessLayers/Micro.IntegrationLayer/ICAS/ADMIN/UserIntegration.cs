...
namespace Micro.IntegrationLayer.ICAS.ADMIN
{
    public partial class UserIntegration
    {
        ...
        public static int InsertUserFeedback(UserFeedback userFeedback)
        {
        ...
        public static List<UserFeedbackCategory> SelectUserFeedbackCategory()
        {
            ...
            DataTable dt = UserDataAccess.GetInstance.SelectUserFeedbackCategory();
            foreach (DataRow dr in dt.Rows)
            {
                UserFeedbackCategory userFeedbackCategory = new UserFeedbackCategory
                {
                    id = int.Parse(dr["id"].ToString()),
                    name = dr["name"].ToString(),
                };

                list.Add(userFeedbackCategory);
            }
            return list;
        }
