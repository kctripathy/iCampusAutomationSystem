...
namespace Micro.IntegrationLayer.FinancialAccounts
{
    public partial class AccountTransactionIntegration
    {
        ...
        public static int DeleteAccountTransaction(AccountTransaction theAccountTransaction)
        {
            return AccountTransactionDataAccess.GetInstance.DeleteAccountTransaction(theAccountTransaction);
        }
        #endregion
    }
}
