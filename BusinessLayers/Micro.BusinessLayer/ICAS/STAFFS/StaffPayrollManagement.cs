...
{
    public partial class StaffPayrollManagement
    {
        #region Code to make this as Singleton Class
        /// <summary>
        /// Declare a private static variable
        /// </summary>
        private static StaffPayrollManagement _Instance;

        /// <summary>
        /// Return the instance of the application by initialising once only.
        /// </summary>
        public static StaffPayrollManagement GetInstance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = new StaffPayrollManagement();
                }
                return _Instance;
            }
            set
